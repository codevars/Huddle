...
public class FeedClassPostsAdapter extends BaseAdapter {
    ...
    public FeedClassPostsAdapter(Activity activity, List<FeedItem> feedItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.feed_post, null);
        ...
        verification = (TextView) convertView.findViewById(R.id.verificationtag);
